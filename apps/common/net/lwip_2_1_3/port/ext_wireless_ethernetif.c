...
extern void ext_netdev_rx_register(void (*fun)(void *priv, void *data, unsigned int len), void *priv);
extern int netdev_get_mac_addr(char *mac_addr);
extern void *ext_netdev_alloc_output_buf(unsigned char **buf, unsigned int len);
extern int ext_netdev_send_data(void *priv, void *skb);
