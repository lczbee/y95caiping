...
#if (TCFG_LCD_NB3030_ENABLE || TCFG_LCD_GC9307_172X320)
    touch_x = mytouch_data.point.x;
    touch_y = VK_Y - mytouch_data.point.y - 1;
#endif//TCFG_LCD_NB3030_ENABLE
#if TCFG_LCD_JD9853_320X147  //820
    touch_x = mytouch_data.point.y;
    touch_y = VK_Y - mytouch_data.point.x;
#endif
