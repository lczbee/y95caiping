...
static u32 drawer_page_list[] = {ID_WINDOW_SET, ID_WINDOW_SLEEP, ID_WINDOW_CALCULATOR, ID_WINDOW_MESS, ID_WINDOW_CALCULAGRAPH, DIAL_PAGE_0, ID_WINDOW_TRAIN, ID_WINDOW_MUSIC, ID_WINDOW_WEATHER, ID_WINDOW_HEART, ID_WINDOW_COMPASS, ID_WINDOW_AI};
