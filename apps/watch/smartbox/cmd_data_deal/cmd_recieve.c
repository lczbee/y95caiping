...
void cmd_recieve(void *priv, u8 OpCode, u8 OpCode_SN, u8 *data, u16 len)
{
    ...
    case JL_OPCODE_MASS_DATA:
        ...
        break;
    case JL_OPCODE_COMM_SETTING:
        extern void comm_settiong_recieve(void *priv, u8 OpCode, u8 OpCode_SN, u8 *data, u16 len);
        comm_settiong_recieve(priv, OpCode, OpCode_SN, data, len);
        break;
