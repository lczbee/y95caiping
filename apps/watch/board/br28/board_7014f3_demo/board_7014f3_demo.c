...
// 触摸屏 和 屏公用复位，先初始化触摸
    ...
    cst816s_init();
#endif  /* LV_LOW_POWER_EN */
#endif /* TCFG_TP_CST816S_ENABLE */
...
void board_set_soft_poweroff(void)
{
    ...
    // 配置7014 RX口上拉输入，用于关机后串口唤醒
    gpio_direction_input(UART_RX_982);
    gpio_set_pull_down(UART_RX_982, 0);
    gpio_set_pull_up(UART_RX_982, 1);
    gpio_set_die(UART_RX_982, 1);
    soff_gpio_protect(UART_RX_982);
...
#endif /* #ifdef CONFIG_BOARD_7014F3_DEMO*/
