#ifndef CONFIG_BOARD_7014F3_DEMO_CFG_H
#define CONFIG_BOARD_7014F3_DEMO_CFG_H

#include "board_7014f3_demo_global_build_cfg.h"

#ifdef CONFIG_BOARD_7014F3_DEMO
...
#if  (CONFIG_FLASH_SIZE == (4*1024*1024))
#undef  TCFG_NORFLASH_SFC_DEV_ENABLE
#define TCFG_NORFLASH_SFC_DEV_ENABLE     	DISABLE
...
//内置FLASH虚拟文件系统空间大小
//2.4m(0x232000) - 128k  = 0x212000
#define TCFG_VIRFAT_INSERT_FLASH_SIZE	  	(0x232000-(!!TCFG_NOR_VM)*CONFIG_EXTERN_USER_VM_FLASH_SIZE)
#define TCFG_VIRFAT_INSERT_FLASH_BASE	  	0x1cc000 //1.8m - 8k开始 内置FLASH虚拟文件系统空间基础地址
//需要保留flash 最后8k 空间
...
//ini 工具文件使用 工具只能识别立即数 要和上面数据对上
#define CONFIG_RULE_INSERT_FLASH_BASE	  	0x1cc000 //1.8m - 8k开始 内置FLASH虚拟文件系统空间基础地址
#define CONFIG_RULE_INSERT_FLASH_SIZE	  	0x212000
#define CONFIG_RULE_INSERT_UI_VM_BASE	  	0x3de000 //(1.8m - 8k) + 2.4m - 128k开始
#define CONFIG_RULE_INSERT_UI_VM_SIZE	  	0x20000//128k
...
#define TCFG_LCD_NB3030_ENABLE              0
...
#define TCFG_LCD_JD9853_320X147             1
...
#define LV_SOC_CHECK    1   //  新彩屏仓电池电量检查开关

#define LV_LOW_POWER_EN             (1) // lvgl低功耗开关
#define LV_LOW_POWER_ENTER_TIME     (10) // lvgl进入低功耗时间，单位为秒
...
#endif //CONFIG_BOARD_7014F3_DEMO
#endif //CONFIG_BOARD_7014F3_DEMO_CFG_H
