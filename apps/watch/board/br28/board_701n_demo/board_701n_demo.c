...
#if LV_LOW_POWER_EN
    soff_gpio_protect(IO_PORTA_06);
    soff_gpio_protect(TCFG_TP_INT_IO);
    soff_gpio_protect(IO_PORTA_02);
    soff_gpio_protect(IO_PORTA_03);
    soff_gpio_protect(IO_PORTA_04);
    soff_gpio_protect(IO_PORTA_07);
    soff_gpio_protect(IO_PORTA_08);
    soff_gpio_protect(IO_PORTB_03);
#endif
