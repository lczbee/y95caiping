...
#define PC_AUDIO_EMITTER                    0///ENABLE_THIS_MOUDLE  //电脑音频从蓝牙发射器输出、没有蓝牙从dac输出
...
#define TCFG_LCD_NB3030_ENABLE              DISABLE_THIS_MOUDLE//ENABLE_THIS_MOUDLE
#define TCFG_LCD_SPI_ICNA3310B_ENABLE       DISABLE_THIS_MOUDLE
#define TCFG_LCD_GC9307_240X283             DISABLE_THIS_MOUDLE
#define TCFG_LCD_GC9307_172X320             ENABLE_THIS_MOUDLE
...
#define TCFG_POWER_ON_NEED_CHARGE				  1	  //是否需要充电激活开机配置
...
#define LV_LOW_POWER_EN             (0) // lvgl低功耗开关
#define LV_LOW_POWER_ENTER_TIME     (40) // lvgl进入低功耗时间，单位为秒
