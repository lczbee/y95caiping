...
..\..\fat_comm.exe -pad-backup2 -force-align-fat -out new_res.bin -image-size 8 -filelist myFont.bin ui MYLOCK.RES BG CBG L2B L3B L4B L5B CHG PWO WAT -remove-empty -remove-bpb -mark-bad-after 0x5e0000 -address 0
