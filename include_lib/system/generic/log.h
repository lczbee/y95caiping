...
#define b_printf(x, ...)  printf("\e[34m\e[1m" x "\e[0m", ## __VA_ARGS__)
#define p_printf(x, ...)  printf("\e[35m\e[1m" x "\e[0m", ## __VA_ARGS__)
#define n_printf(x, ...)  printf("\e[36m\e[1m" x "\e[0m", ## __VA_ARGS__)
