 ...
 *********************/
typedef enum {
    LV_IMGBTN_STATE_RELEASED,             //按钮未被按下且处于正常状态。
    LV_IMGBTN_STATE_PRESSED,              //按钮被按下，表示用户正在与其交互
    LV_IMGBTN_STATE_DISABLED,             //按钮被禁用，用户无法与其交互
    LV_IMGBTN_STATE_CHECKED_RELEASED,     //按钮处于选中状态但未被按下
    LV_IMGBTN_STATE_CHECKED_PRESSED,      //按钮处于选中状态且被按下
    LV_IMGBTN_STATE_CHECKED_DISABLED,     //按钮处于选中状态且被禁用
