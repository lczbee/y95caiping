...
/*
	...
	lv_obj_set_style_text_font(ui->screen_lock_label_lock_hour, &lv_customer_font_pingfangheiti_bold_56, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_lock_label_lock_min, &lv_customer_font_pingfangheiti_bold_56, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_lock_label_lock_MD, &lv_customer_font_pingfangheiti_bold_24, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_lock_label_lock_week, &lv_customer_font_pingfangheiti_bold_24, LV_PART_MAIN|LV_STATE_DEFAULT);
